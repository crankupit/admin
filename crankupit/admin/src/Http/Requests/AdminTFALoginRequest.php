...
class AdminTFALoginRequest extends FormRequest
{
    /**
    ...
    {
        return $this->code && tap(app(AdminTFAProvider::class)->verify(
    ...
    public function challengedUser()
    {
        ...
        if (
            ...
            throw new HttpResponseException(
                app(AdminFailedTFALoginResponse::class)->toResponse($this)
            );
        }
